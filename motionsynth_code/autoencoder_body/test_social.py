...
checkpointRoot = './'
checkpointFolder = checkpointRoot+ '/social_autoencoder_first_try5/'
preTrainFileName= 'checkpoint_e2000_loss1.2245.pth'
...
for _, bi in enumerate(batchinds):
    ...
    glViewer.show_Holden_Data_73([inputData_np_ori, output_np] )
