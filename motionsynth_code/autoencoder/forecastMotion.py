...
folderNames =['autoencoder_3conv_vect3_2',6250,
        'autoencoder_3conv_vect3_8',6100,
        'autoencoder_3conv_vect3_64',4450]

#folderNames =['autoencoder_first',5000]
#folderNames =['autoencoder_3conv_vae_try6',4600]
folderNames =['forecast_autoencoder_3convLayers_vect',18300]
...
for folderName, loadEpoch in zip(folderNames[0::2],folderNames[1::2]):
    ...
    #loadEpoch = 1000
    model = getattr(modelZoo,options_dict['model'])(160)
