...
checkpointRoot = './'
checkpointFolder = checkpointRoot+ '/social_autoencoder_first_try4/'
preTrainFileName= 'checkpoint_e100_loss0.0351.pth'


checkpointRoot = './'
checkpointFolder = checkpointRoot+ '/social_autoencoder_first_16_try5/'
preTrainFileName= 'checkpoint_e150_loss0.0324.pth'


checkpointRoot = '/posefs2b/Users/hanbyulj/pytorch_motionSynth/checkpoint/'
checkpointFolder = checkpointRoot+ '/social_autoencoder_first_16/'
