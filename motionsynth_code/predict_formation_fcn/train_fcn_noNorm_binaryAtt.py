...
train_dblist = ['data_hagglingSellers_speech_formation_240frm_5gap_white_brl_atten_training']
test_dblist = ['data_hagglingSellers_speech_formation_240frm_5gap_white_brl_atten_testing']       
...
train_attention_raw = train_data['attention'] #[pIdx](chunkNum, frames, 73)
...
train_X_attention = train_attention_raw[0]    #(chunkNum, frames, feagureDim:2)
train_X_attention = np.concatenate( (train_X_attention, train_attention_raw[1]), axis= 2)      #(chunkNum, frames, featureDim:4)
train_Y_attention = train_attention_raw[2]  #(chunkNum, frames, featureDim:2)

train_X = np.concatenate( (train_X, train_X_attention), axis= 2 )     #(num, chunkLength,4+4 )
train_Y = np.concatenate( (train_Y, train_Y_attention), axis= 2 )      #(num, chunkLength,2+2 )
...
test_X = np.concatenate( (test_X, test_X_attention), axis= 2 )     #(num, chunkLength,4+4 )
test_Y = np.concatenate( (test_Y, test_Y_attention), axis= 2 )      #(num, chunkLength,2+2 )



## Change the second and third 
if augmentAfterSwap== True:
