...
# input: 3 x frames 
# output:69 x frames
class regressor_holden(nn.Module):
    def __init__(self):
        super(regressor_holden, self).__init__()

        self.encoder = nn.Sequential(
            nn.Dropout(0.25),
            nn.Conv1d(3,64,45,padding=22),        #256, 73, 200
            nn.ReLU(),
        ...
        self.decoder = nn.Sequential(
            ...
            nn.Dropout(0.25),
            nn.ConvTranspose1d(256, 69, 25, stride=2, padding=12, output_padding=1),
            #nn.ReLU(True)
          )  
...
# input: 3 x frames 
# output:73 x frames
class regressor_holden_73(nn.Module):
    def __init__(self):
        super(regressor_holden_73, self).__init__()
