...
class Animation:
    ...
    (by jhugestar: positions has initial 3 values for the global root position, and relative offest for other joints.
    This offests are the one in the skeleton defintion in BVH files, and exactly the same in all frames (assuming fixed skeleton)
    )
